...
/**
 * Servlet implementation class AddAccidentGeneralServlet
 */
public class AddAccidentGeneralServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddAccidentGeneralServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		if(datetime != null && longtitude != null && latitude != null && degree != null && userid  != null)
		{
			...
			accidentGeneral.setDegree(degree);
			accidentGeneral.setChecked(0);
			accidentGeneral.setUserid(userid);
	
			if(CptedController.getInstance().AddAccidentGeneral(
					accidentGeneral))
			{
				
				
				Gson gson = new Gson();
				String addAccidentGeneralJson = gson.toJson(accidentGeneral);
